...
def main():
    ...
    default_model = script_dir / 'runs' / 'train' / 'smoking_detection_v6_optimized' / 'weights' / 'best.pt'
    ...
    parser.add_argument('--input-dir', type=str, default=str(script_dir / 'input_data' / 'images'), help='Input directory chứa ảnh')
    ...
    if args.image is not None:
        ...
        if not image_list:
            ...
            test_images = glob.glob('../dataset/smoking_train_image/test/images/*.jpg')[:5]
            if test_images:
                import shutil
